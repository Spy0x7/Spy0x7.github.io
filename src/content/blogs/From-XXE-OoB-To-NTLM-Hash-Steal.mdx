...
slug: from-xxe-oob-to-ntlm-thief
description: This writeup demonstrates how a blind XXE vulnerability can be chained to extract local files, perform internal port scanning, and steal NTLM hashes via SMB in a real-world API scenario.
date: 2020-08-20
image: from-xxe-oob-to-ntlm-thief/burp_collab.png
---
...
<FixTheImageURL src="burp_collab.png" slug="from-xxe-oob-to-ntlm-thief" />
...
<FixTheImageURL src="msfsmb.png" slug="from-xxe-oob-to-ntlm-thief" />

Bingo!

<FixTheImageURL src="smb.png" slug="from-xxe-oob-to-ntlm-thief" />
