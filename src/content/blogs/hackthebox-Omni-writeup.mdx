...
slug: hackthebox-omni-writeup
description: Exploiting SirepRAT to gain SYSTEM shell on a Windows IoT Core box via unauthenticated RCE and credential leakage.
date: 2021-08-02
image: website.png
---
...
Visiting [http://10.10.10.204:8080](http://10.10.10.204:8080) presents a login prompt for **Windows Device Portal**:


<FixTheImageURL src="website.png" slug="Omni" />
...
<FixTheImageURL src="app.png" slug="Omni" />
...
<FixTheImageURL src="admin.png" slug="Omni" />
