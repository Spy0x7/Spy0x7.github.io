...
slug: odata-ssrf-fun-filter-injection
description: Exploiting OData filter injection and SSRF via custom proxy headers in a financial platform.
date: 2025-05-25
image: odata/info.png
---
...
<FixTheImageURL src="info.png" slug="odata" />
...
<FixTheImageURL src="localhost.png" slug="odata" />


<FixTheImageURL src="burp.png" slug="odata" />
