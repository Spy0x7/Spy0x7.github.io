...
<FixTheImageURL src="home.png" slug="routerspace" />
...
<FixTheImageURL src="install.png" slug="routerspace" />


Install the app, then open

<FixTheImageURL src="click.png" slug="routerspace" />



click on Check Status and intercept this in burp.

<FixTheImageURL src="intercept.png" slug="routerspace" />


send it to repeater tab.

<FixTheImageURL src="repeater.png" slug="routerspace" />
...
<FixTheImageURL src="id.png" slug="routerspace" />
...
[GitHub: Sudo 1.8.31 Root Exploit](https://github.com/mohinparamasivam/Sudo-1.8.31-Root-Exploit)
